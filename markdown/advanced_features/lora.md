...
```
    ...
    2026-04-01 06:39:28.189 DEBUG Persistent cache disabled, using in-memory JIT cache
    ...
    2026-04-01 06:39:41,330 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-01 06:39:41] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    2026-04-01 06:40:04.867 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:40:04] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 06:40:04.867 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:40:04] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 06:40:04.867 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:40:04] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 06:40:04.867 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:40:04] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 06:40:04.868 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:40:04] Persistent cache disabled, using in-memory JIT cache
    ...
    2026-04-01 06:40:15,538 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-01 06:40:15] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    2026-04-01 06:40:42.049 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:40:42] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 06:40:42.049 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:40:42] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 06:40:42.049 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:40:42] Persistent cache disabled, using in-memory JIT cache
    ...
    2026-04-01 06:40:52,753 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-01 06:40:52] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 237.18it/s]
...
```
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 84.28it/s]
...
```
    ...
    2026-04-01 06:41:22.656 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:41:22] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 06:41:22.656 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:41:22] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 06:41:22.656 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 06:41:22] Persistent cache disabled, using in-memory JIT cache
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 279.17it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 70492.50it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 16368.02it/s]
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 145.90it/s]
    ...
    2026-04-01 06:41:34,930 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-01 06:42:02] Load weight begin. avail mem=42.47 GB
    [2026-04-01 06:42:02] Found local HF snapshot for meta-llama/Meta-Llama-3.1-8B-Instruct at /root/.cache/huggingface/hub/models--meta-llama--Meta-Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659; skipping download.
    ...
    [2026-04-01 06:42:05] Load weight end. elapsed=3.81 s, type=LlamaForCausalLM, avail mem=45.15 GB, mem usage=-2.68 GB.
    [2026-04-01 06:42:05] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18957.31it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 13695.69it/s]
    [2026-04-01 06:42:05] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    [2026-04-01 06:42:06] No model.safetensors.index.json found in remote.
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 255.72it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 21592.30it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19108.45it/s]
    [2026-04-01 06:42:06] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    [2026-04-01 06:42:06] No model.safetensors.index.json found in remote.
    ...
    [2026-04-01 06:42:06] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    [2026-04-01 06:42:06] No model.safetensors.index.json found in remote.
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 96.52it/s]


    [2026-04-01 06:42:10] Using KV cache dtype: torch.bfloat16
    [2026-04-01 06:42:10] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-04-01 06:42:10] Memory pool end. avail mem=39.90 GB
    [2026-04-01 06:42:10] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-04-01 06:42:13] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=39.81 GB


    [2026-04-01 06:42:14] SubprocessWatchdog started, monitoring 2 process(es)
    [2026-04-01 06:42:14] INFO:     Started server process [3948981]
    [2026-04-01 06:42:14] INFO:     Waiting for application startup.
    [2026-04-01 06:42:14] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-04-01 06:42:14] INFO:     Application startup complete.
    [2026-04-01 06:42:14] INFO:     Uvicorn running on http://127.0.0.1:36240 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-04-01 06:42:14] INFO:     127.0.0.1:41342 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-04-01 06:42:15] INFO:     127.0.0.1:41356 - "GET /model_info HTTP/1.1" 200 OK


    2026-04-01 06:42:19,189 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-01 06:42:19] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-01 06:42:19] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 3, cuda graph: False, input throughput (token/s): 0.00
    [2026-04-01 06:42:20] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 2, cuda graph: False, input throughput (token/s): 92.52
    [2026-04-01 06:42:20] INFO:     127.0.0.1:41372 - "POST /generate HTTP/1.1" 200 OK
    [2026-04-01 06:42:20] The server is fired up and ready to roll!


    [2026-04-01 06:42:20] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, cuda graph: False, input throughput (token/s): 31.62


    [2026-04-01 06:42:20] Decode batch, #running-req: 2, #token: 87, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.03, #queue-req: 1


    [2026-04-01 06:42:21] Decode batch, #running-req: 1, #token: 89, token usage: 0.00, cuda graph: False, gen throughput (token/s): 83.69, #queue-req: 1
    [2026-04-01 06:42:21] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, cuda graph: False, input throughput (token/s): 5.52


    [2026-04-01 06:42:22] Decode batch, #running-req: 2, #token: 176, token usage: 0.01, cuda graph: False, gen throughput (token/s): 71.82, #queue-req: 0


    [2026-04-01 06:42:23] Decode batch, #running-req: 1, #token: 169, token usage: 0.01, cuda graph: False, gen throughput (token/s): 67.62, #queue-req: 0


    [2026-04-01 06:42:24] Decode batch, #running-req: 1, #token: 209, token usage: 0.01, cuda graph: False, gen throughput (token/s): 46.70, #queue-req: 0


    [2026-04-01 06:42:25] Decode batch, #running-req: 1, #token: 249, token usage: 0.01, cuda graph: False, gen throughput (token/s): 49.51, #queue-req: 0


    [2026-04-01 06:42:26] Decode batch, #running-req: 1, #token: 289, token usage: 0.01, cuda graph: False, gen throughput (token/s): 50.07, #queue-req: 0


    [2026-04-01 06:42:27] Decode batch, #running-req: 1, #token: 329, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.14, #queue-req: 0


    [2026-04-01 06:42:28] Decode batch, #running-req: 1, #token: 369, token usage: 0.02, cuda graph: False, gen throughput (token/s): 48.25, #queue-req: 0


    [2026-04-01 06:42:28] Decode batch, #running-req: 1, #token: 409, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.67, #queue-req: 0


    [2026-04-01 06:42:29] Decode batch, #running-req: 1, #token: 449, token usage: 0.02, cuda graph: False, gen throughput (token/s): 46.94, #queue-req: 0


    [2026-04-01 06:42:30] Decode batch, #running-req: 1, #token: 489, token usage: 0.02, cuda graph: False, gen throughput (token/s): 35.67, #queue-req: 0


    [2026-04-01 06:42:32] Decode batch, #running-req: 1, #token: 529, token usage: 0.03, cuda graph: False, gen throughput (token/s): 31.28, #queue-req: 0


    [2026-04-01 06:42:33] Decode batch, #running-req: 1, #token: 569, token usage: 0.03, cuda graph: False, gen throughput (token/s): 31.03, #queue-req: 0


    [2026-04-01 06:42:34] Decode batch, #running-req: 1, #token: 609, token usage: 0.03, cuda graph: False, gen throughput (token/s): 31.07, #queue-req: 0


    [2026-04-01 06:42:35] Decode batch, #running-req: 1, #token: 649, token usage: 0.03, cuda graph: False, gen throughput (token/s): 31.32, #queue-req: 0


    [2026-04-01 06:42:37] Decode batch, #running-req: 1, #token: 689, token usage: 0.03, cuda graph: False, gen throughput (token/s): 31.88, #queue-req: 0


    [2026-04-01 06:42:38] Decode batch, #running-req: 1, #token: 729, token usage: 0.04, cuda graph: False, gen throughput (token/s): 35.21, #queue-req: 0


    [2026-04-01 06:42:39] Decode batch, #running-req: 1, #token: 769, token usage: 0.04, cuda graph: False, gen throughput (token/s): 39.09, #queue-req: 0


    [2026-04-01 06:42:40] Decode batch, #running-req: 1, #token: 809, token usage: 0.04, cuda graph: False, gen throughput (token/s): 44.90, #queue-req: 0


    [2026-04-01 06:42:41] Decode batch, #running-req: 1, #token: 849, token usage: 0.04, cuda graph: False, gen throughput (token/s): 32.95, #queue-req: 0


    [2026-04-01 06:42:42] Decode batch, #running-req: 1, #token: 889, token usage: 0.04, cuda graph: False, gen throughput (token/s): 31.26, #queue-req: 0


    [2026-04-01 06:42:43] Decode batch, #running-req: 1, #token: 929, token usage: 0.05, cuda graph: False, gen throughput (token/s): 32.89, #queue-req: 0


    [2026-04-01 06:42:45] Decode batch, #running-req: 1, #token: 969, token usage: 0.05, cuda graph: False, gen throughput (token/s): 35.31, #queue-req: 0


    [2026-04-01 06:42:45] Decode batch, #running-req: 1, #token: 1009, token usage: 0.05, cuda graph: False, gen throughput (token/s): 46.47, #queue-req: 0


    [2026-04-01 06:42:46] INFO:     127.0.0.1:41384 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
