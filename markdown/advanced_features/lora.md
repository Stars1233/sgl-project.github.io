...
```
    ...
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    2026-03-30 08:39:19.972 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:39:19] Persistent cache disabled, using in-memory JIT cache
    2026-03-30 08:39:19.972 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:39:19] Persistent cache disabled, using in-memory JIT cache
    2026-03-30 08:39:19.972 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:39:19] Persistent cache disabled, using in-memory JIT cache
...
```
    ...
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    2026-03-30 08:39:53.263 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:39:53] Persistent cache disabled, using in-memory JIT cache
    2026-03-30 08:39:53.263 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:39:53] Persistent cache disabled, using in-memory JIT cache
    2026-03-30 08:39:53.263 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:39:53] Persistent cache disabled, using in-memory JIT cache
...
```
    ...
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    2026-03-30 08:40:25.177 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:40:25] Persistent cache disabled, using in-memory JIT cache
    2026-03-30 08:40:25.177 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:40:25] Persistent cache disabled, using in-memory JIT cache
    2026-03-30 08:40:25.177 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:40:25] Persistent cache disabled, using in-memory JIT cache
...
```
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 244.42it/s]
...
```
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 135.04it/s]
...
```
    ...
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    2026-03-30 08:40:58.786 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:40:58] Persistent cache disabled, using in-memory JIT cache
    2026-03-30 08:40:58.786 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:40:58] Persistent cache disabled, using in-memory JIT cache
    2026-03-30 08:40:58.786 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-30 08:40:58] Persistent cache disabled, using in-memory JIT cache
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 308.90it/s]
...
```
    ...
    Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 135.44it/s]
...
```
    ...
    [2026-03-30 08:41:33] Load weight begin. avail mem=73.94 GB


    [2026-03-30 08:41:34] Found local HF snapshot for meta-llama/Meta-Llama-3.1-8B-Instruct at /root/.cache/huggingface/hub/models--meta-llama--Meta-Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659; skipping download.
    ...
    [2026-03-30 08:41:36] Load weight end. elapsed=3.04 s, type=LlamaForCausalLM, avail mem=54.74 GB, mem usage=19.20 GB.
    [2026-03-30 08:41:36] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19021.79it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 83055.52it/s]
    [2026-03-30 08:41:36] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    [2026-03-30 08:41:36] No model.safetensors.index.json found in remote.
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 293.27it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 12219.39it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 20687.07it/s]
    [2026-03-30 08:41:37] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    [2026-03-30 08:41:37] No model.safetensors.index.json found in remote.
    ...
    [2026-03-30 08:41:37] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    [2026-03-30 08:41:37] No model.safetensors.index.json found in remote.
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 106.33it/s]


    [2026-03-30 08:41:40] Using KV cache dtype: torch.bfloat16
    [2026-03-30 08:41:40] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-03-30 08:41:40] Memory pool end. avail mem=53.25 GB
    [2026-03-30 08:41:40] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-03-30 08:41:42] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=52.62 GB


    [2026-03-30 08:41:43] SubprocessWatchdog started, monitoring 2 process(es)
    [2026-03-30 08:41:43] INFO:     Started server process [2273099]
    [2026-03-30 08:41:43] INFO:     Waiting for application startup.
    [2026-03-30 08:41:43] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-03-30 08:41:43] INFO:     Application startup complete.
    [2026-03-30 08:41:43] INFO:     Uvicorn running on http://127.0.0.1:37175 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-03-30 08:41:43] INFO:     127.0.0.1:50448 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-03-30 08:41:44] INFO:     127.0.0.1:50454 - "GET /model_info HTTP/1.1" 200 OK


    [2026-03-30 08:41:44] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, cuda graph: False, input throughput (token/s): 0.00
    [2026-03-30 08:41:44] INFO:     127.0.0.1:50460 - "POST /generate HTTP/1.1" 200 OK
    [2026-03-30 08:41:44] The server is fired up and ready to roll!
...
```
    ...
    [2026-03-30 08:41:48] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 1, cuda graph: False, input throughput (token/s): 1.67
    [2026-03-30 08:41:48] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, cuda graph: False, input throughput (token/s): 216.82


    [2026-03-30 08:41:49] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.47, #queue-req: 1


    [2026-03-30 08:41:50] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, cuda graph: False, input throughput (token/s): 7.90
    [2026-03-30 08:41:50] Decode batch, #running-req: 2, #token: 95, token usage: 0.00, cuda graph: False, gen throughput (token/s): 108.89, #queue-req: 0


    [2026-03-30 08:41:50] Decode batch, #running-req: 2, #token: 175, token usage: 0.01, cuda graph: False, gen throughput (token/s): 124.69, #queue-req: 0


    [2026-03-30 08:41:51] Decode batch, #running-req: 1, #token: 162, token usage: 0.01, cuda graph: False, gen throughput (token/s): 100.69, #queue-req: 0


    [2026-03-30 08:41:51] Decode batch, #running-req: 1, #token: 202, token usage: 0.01, cuda graph: False, gen throughput (token/s): 67.10, #queue-req: 0


    [2026-03-30 08:41:52] Decode batch, #running-req: 1, #token: 242, token usage: 0.01, cuda graph: False, gen throughput (token/s): 64.59, #queue-req: 0


    [2026-03-30 08:41:53] Decode batch, #running-req: 1, #token: 282, token usage: 0.01, cuda graph: False, gen throughput (token/s): 61.50, #queue-req: 0


    [2026-03-30 08:41:53] Decode batch, #running-req: 1, #token: 322, token usage: 0.02, cuda graph: False, gen throughput (token/s): 66.75, #queue-req: 0


    [2026-03-30 08:41:54] Decode batch, #running-req: 1, #token: 362, token usage: 0.02, cuda graph: False, gen throughput (token/s): 67.62, #queue-req: 0


    [2026-03-30 08:41:54] Decode batch, #running-req: 1, #token: 402, token usage: 0.02, cuda graph: False, gen throughput (token/s): 67.59, #queue-req: 0


    [2026-03-30 08:41:55] Decode batch, #running-req: 1, #token: 442, token usage: 0.02, cuda graph: False, gen throughput (token/s): 68.96, #queue-req: 0


    [2026-03-30 08:41:56] Decode batch, #running-req: 1, #token: 482, token usage: 0.02, cuda graph: False, gen throughput (token/s): 65.71, #queue-req: 0


    [2026-03-30 08:41:56] Decode batch, #running-req: 1, #token: 522, token usage: 0.03, cuda graph: False, gen throughput (token/s): 67.71, #queue-req: 0


    [2026-03-30 08:41:57] Decode batch, #running-req: 1, #token: 562, token usage: 0.03, cuda graph: False, gen throughput (token/s): 67.54, #queue-req: 0


    [2026-03-30 08:41:57] Decode batch, #running-req: 1, #token: 602, token usage: 0.03, cuda graph: False, gen throughput (token/s): 64.45, #queue-req: 0


    [2026-03-30 08:41:58] Decode batch, #running-req: 1, #token: 642, token usage: 0.03, cuda graph: False, gen throughput (token/s): 66.78, #queue-req: 0


    [2026-03-30 08:41:59] Decode batch, #running-req: 1, #token: 682, token usage: 0.03, cuda graph: False, gen throughput (token/s): 64.67, #queue-req: 0


    [2026-03-30 08:41:59] Decode batch, #running-req: 1, #token: 722, token usage: 0.04, cuda graph: False, gen throughput (token/s): 61.76, #queue-req: 0


    [2026-03-30 08:42:00] Decode batch, #running-req: 1, #token: 762, token usage: 0.04, cuda graph: False, gen throughput (token/s): 63.15, #queue-req: 0


    [2026-03-30 08:42:01] Decode batch, #running-req: 1, #token: 802, token usage: 0.04, cuda graph: False, gen throughput (token/s): 64.19, #queue-req: 0


    [2026-03-30 08:42:01] Decode batch, #running-req: 1, #token: 842, token usage: 0.04, cuda graph: False, gen throughput (token/s): 58.07, #queue-req: 0


    [2026-03-30 08:42:02] Decode batch, #running-req: 1, #token: 882, token usage: 0.04, cuda graph: False, gen throughput (token/s): 47.40, #queue-req: 0


    [2026-03-30 08:42:03] Decode batch, #running-req: 1, #token: 922, token usage: 0.05, cuda graph: False, gen throughput (token/s): 46.83, #queue-req: 0


    [2026-03-30 08:42:04] Decode batch, #running-req: 1, #token: 962, token usage: 0.05, cuda graph: False, gen throughput (token/s): 65.21, #queue-req: 0


    [2026-03-30 08:42:05] Decode batch, #running-req: 1, #token: 1002, token usage: 0.05, cuda graph: False, gen throughput (token/s): 42.73, #queue-req: 0


    [2026-03-30 08:42:05] INFO:     127.0.0.1:32768 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
