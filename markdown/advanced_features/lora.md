...
```
    ...
    2026-04-04 01:39:17,252 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-04 01:39:17] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    2026-04-04 01:39:50,511 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-04 01:39:50] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    2026-04-04 01:40:24,214 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-04 01:40:24] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 169.68it/s]
    ...
    2026-04-04 01:41:02,588 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-04 01:41:02] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-04 01:41:30] Load weight end. elapsed=3.72 s, type=LlamaForCausalLM, avail mem=25.49 GB, mem usage=15.07 GB.
    [2026-04-04 01:41:30] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 23014.01it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 93727.46it/s]
    [2026-04-04 01:41:30] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    [2026-04-04 01:41:30] No model.safetensors.index.json found in remote.
    ...
    [2026-04-04 01:41:30] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    [2026-04-04 01:41:30] No model.safetensors.index.json found in remote.
    ...
    [2026-04-04 01:41:31] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    [2026-04-04 01:41:31] No model.safetensors.index.json found in remote.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 113.09it/s]


    [2026-04-04 01:41:34] Using KV cache dtype: torch.bfloat16
    [2026-04-04 01:41:34] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-04-04 01:41:34] Memory pool end. avail mem=20.23 GB
    [2026-04-04 01:41:34] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-04-04 01:41:36] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=20.13 GB


    [2026-04-04 01:41:37] INFO:     Started server process [2349811]
    [2026-04-04 01:41:37] INFO:     Waiting for application startup.
    [2026-04-04 01:41:37] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-04-04 01:41:37] INFO:     Application startup complete.
    [2026-04-04 01:41:37] INFO:     Uvicorn running on http://127.0.0.1:31714 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-04-04 01:41:37] INFO:     127.0.0.1:32914 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-04-04 01:41:38] INFO:     127.0.0.1:32918 - "GET /model_info HTTP/1.1" 200 OK


    2026-04-04 01:41:38,852 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-04 01:41:38] Unexpected error during package walk: cutlass.cute.experimental


    [2026-04-04 01:41:39] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, cuda graph: False, input throughput (token/s): 0.00
    [2026-04-04 01:41:39] INFO:     127.0.0.1:32934 - "POST /generate HTTP/1.1" 200 OK
    [2026-04-04 01:41:39] The server is fired up and ready to roll!
...
```
    ...
    [2026-04-04 01:41:42] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 1, cuda graph: False, input throughput (token/s): 2.22
    [2026-04-04 01:41:42] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, cuda graph: False, input throughput (token/s): 484.41


    [2026-04-04 01:41:43] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.27, #queue-req: 1


    [2026-04-04 01:41:44] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, cuda graph: False, input throughput (token/s): 5.84
    [2026-04-04 01:41:44] Decode batch, #running-req: 2, #token: 93, token usage: 0.00, cuda graph: False, gen throughput (token/s): 78.14, #queue-req: 0


    [2026-04-04 01:41:45] Decode batch, #running-req: 2, #token: 173, token usage: 0.01, cuda graph: False, gen throughput (token/s): 85.77, #queue-req: 0


    [2026-04-04 01:41:46] Decode batch, #running-req: 1, #token: 162, token usage: 0.01, cuda graph: False, gen throughput (token/s): 72.92, #queue-req: 0


    [2026-04-04 01:41:46] Decode batch, #running-req: 1, #token: 202, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.79, #queue-req: 0


    [2026-04-04 01:41:47] Decode batch, #running-req: 1, #token: 242, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.70, #queue-req: 0


    [2026-04-04 01:41:48] Decode batch, #running-req: 1, #token: 282, token usage: 0.01, cuda graph: False, gen throughput (token/s): 51.67, #queue-req: 0


    [2026-04-04 01:41:49] Decode batch, #running-req: 1, #token: 322, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.63, #queue-req: 0


    [2026-04-04 01:41:49] Decode batch, #running-req: 1, #token: 362, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.67, #queue-req: 0


    [2026-04-04 01:41:50] Decode batch, #running-req: 1, #token: 402, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.54, #queue-req: 0


    [2026-04-04 01:41:51] Decode batch, #running-req: 1, #token: 442, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.53, #queue-req: 0


    [2026-04-04 01:41:52] Decode batch, #running-req: 1, #token: 482, token usage: 0.02, cuda graph: False, gen throughput (token/s): 51.55, #queue-req: 0


    [2026-04-04 01:41:53] Decode batch, #running-req: 1, #token: 522, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.31, #queue-req: 0


    [2026-04-04 01:41:53] Decode batch, #running-req: 1, #token: 562, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.53, #queue-req: 0


    [2026-04-04 01:41:54] Decode batch, #running-req: 1, #token: 602, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.51, #queue-req: 0


    [2026-04-04 01:41:55] Decode batch, #running-req: 1, #token: 642, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.03, #queue-req: 0


    [2026-04-04 01:41:56] Decode batch, #running-req: 1, #token: 682, token usage: 0.03, cuda graph: False, gen throughput (token/s): 46.65, #queue-req: 0


    [2026-04-04 01:41:57] Decode batch, #running-req: 1, #token: 722, token usage: 0.04, cuda graph: False, gen throughput (token/s): 46.83, #queue-req: 0


    [2026-04-04 01:41:57] Decode batch, #running-req: 1, #token: 762, token usage: 0.04, cuda graph: False, gen throughput (token/s): 57.11, #queue-req: 0


    [2026-04-04 01:41:58] Decode batch, #running-req: 1, #token: 802, token usage: 0.04, cuda graph: False, gen throughput (token/s): 66.62, #queue-req: 0


    [2026-04-04 01:41:58] Decode batch, #running-req: 1, #token: 842, token usage: 0.04, cuda graph: False, gen throughput (token/s): 66.68, #queue-req: 0


    [2026-04-04 01:41:59] Decode batch, #running-req: 1, #token: 882, token usage: 0.04, cuda graph: False, gen throughput (token/s): 66.97, #queue-req: 0


    [2026-04-04 01:42:00] Decode batch, #running-req: 1, #token: 922, token usage: 0.05, cuda graph: False, gen throughput (token/s): 65.62, #queue-req: 0


    [2026-04-04 01:42:00] Decode batch, #running-req: 1, #token: 962, token usage: 0.05, cuda graph: False, gen throughput (token/s): 60.85, #queue-req: 0


    [2026-04-04 01:42:01] Decode batch, #running-req: 1, #token: 1002, token usage: 0.05, cuda graph: False, gen throughput (token/s): 60.82, #queue-req: 0


    [2026-04-04 01:42:02] INFO:     127.0.0.1:32940 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
