...
```
    ...
    2026-04-02 00:16:38.881 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:16:38] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:16:38.881 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:16:38] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:16:38.881 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:16:38] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:16:38.881 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:16:38] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:16:38.882 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:16:38] Persistent cache disabled, using in-memory JIT cache
    ...
    2026-04-02 00:16:48,715 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-02 00:16:48] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    2026-04-02 00:17:12.877 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:17:12] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:17:12.878 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:17:12] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:17:12.878 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:17:12] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:17:12.878 DEBUG Persistent cache disabled, using in-memory JIT cache
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 135.08it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 15563.28it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 11237.25it/s]
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 253.17it/s]
    ...
    2026-04-02 00:17:22,812 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-02 00:17:22] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    2026-04-02 00:17:46.585 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:17:46] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:17:46.585 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:17:46] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:17:46.585 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:17:46] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:17:46.585 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:17:46] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:17:46.586 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:17:46] Persistent cache disabled, using in-memory JIT cache


    Loading safetensors checkpoint shards:   0% Completed | 0/4 [00:00<?, ?it/s]Loading safetensors checkpoint shards:  25% Completed | 1/4 [00:00<00:00,  8.36it/s]
    ...
    Loading safetensors checkpoint shards: 100% Completed | 4/4 [00:01<00:00,  1.80it/s]Loading safetensors checkpoint shards: 100% Completed | 4/4 [00:01<00:00,  2.04it/s]
    ...
    2026-04-02 00:17:55,863 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-02 00:17:55] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 136.63it/s]
...
```
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 1288.18it/s]
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 130.60it/s]
...
```
    ...
    2026-04-02 00:18:23.422 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:18:23] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:18:23.423 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:18:23] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:18:23.423 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-02 00:18:23] Persistent cache disabled, using in-memory JIT cache
    2026-04-02 00:18:23.423 DEBUG Persistent cache disabled, using in-memory JIT cache
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/4 [00:00<?, ?it/s]Loading safetensors checkpoint shards:  25% Completed | 1/4 [00:00<00:00,  8.20it/s]
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 248.12it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 11023.14it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 11074.07it/s]
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 134.35it/s]
    ...
    2026-04-02 00:18:34,713 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-02 00:18:34] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-02 00:19:01] Load weight begin. avail mem=134.60 GB
    [2026-04-02 00:19:01] Found local HF snapshot for meta-llama/Meta-Llama-3.1-8B-Instruct at /root/.cache/huggingface/hub/models--meta-llama--Meta-Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659; skipping download.


    Loading safetensors checkpoint shards:   0% Completed | 0/4 [00:00<?, ?it/s]Loading safetensors checkpoint shards:  25% Completed | 1/4 [00:00<00:00,  8.32it/s]
    ...
    Loading safetensors checkpoint shards: 100% Completed | 4/4 [00:01<00:00,  1.79it/s]Loading safetensors checkpoint shards: 100% Completed | 4/4 [00:01<00:00,  2.04it/s]


    [2026-04-02 00:19:03] Load weight end. elapsed=2.46 s, type=LlamaForCausalLM, avail mem=119.58 GB, mem usage=15.02 GB.
    [2026-04-02 00:19:03] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 11313.02it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 17716.17it/s]
    [2026-04-02 00:19:04] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.


    [2026-04-02 00:19:04] No model.safetensors.index.json found in remote.
    ...
    [2026-04-02 00:19:04] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-04-02 00:19:05] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    [2026-04-02 00:19:05] No model.safetensors.index.json found in remote.
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 85.31it/s]


    [2026-04-02 00:19:08] Using KV cache dtype: torch.bfloat16
    [2026-04-02 00:19:08] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-04-02 00:19:08] Memory pool end. avail mem=99.32 GB
    [2026-04-02 00:19:08] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-04-02 00:19:11] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=102.50 GB


    [2026-04-02 00:19:11] SubprocessWatchdog started, monitoring 2 process(es)
    [2026-04-02 00:19:11] INFO:     Started server process [698474]
    [2026-04-02 00:19:11] INFO:     Waiting for application startup.
    [2026-04-02 00:19:11] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-04-02 00:19:11] INFO:     Application startup complete.
    [2026-04-02 00:19:11] INFO:     Uvicorn running on http://127.0.0.1:34155 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-04-02 00:19:11] INFO:     127.0.0.1:36292 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-04-02 00:19:12] INFO:     127.0.0.1:36296 - "GET /model_info HTTP/1.1" 200 OK


    2026-04-02 00:19:13,060 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-02 00:19:13] Unexpected error during package walk: cutlass.cute.experimental


    [2026-04-02 00:19:13] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, cuda graph: False, input throughput (token/s): 0.00
    [2026-04-02 00:19:13] INFO:     127.0.0.1:36298 - "POST /generate HTTP/1.1" 200 OK
    [2026-04-02 00:19:13] The server is fired up and ready to roll!
...
```
    ...
    [2026-04-02 00:19:16] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 1, cuda graph: False, input throughput (token/s): 2.15
    [2026-04-02 00:19:17] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, cuda graph: False, input throughput (token/s): 422.44


    [2026-04-02 00:19:17] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.28, #queue-req: 1


    [2026-04-02 00:19:18] Decode batch, #running-req: 1, #token: 90, token usage: 0.00, cuda graph: False, gen throughput (token/s): 88.71, #queue-req: 0
    [2026-04-02 00:19:18] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, cuda graph: False, input throughput (token/s): 6.22


    [2026-04-02 00:19:19] Decode batch, #running-req: 2, #token: 172, token usage: 0.01, cuda graph: False, gen throughput (token/s): 94.09, #queue-req: 0


    [2026-04-02 00:19:20] Decode batch, #running-req: 1, #token: 162, token usage: 0.01, cuda graph: False, gen throughput (token/s): 82.11, #queue-req: 0


    [2026-04-02 00:19:20] Decode batch, #running-req: 1, #token: 202, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.62, #queue-req: 0


    [2026-04-02 00:19:21] Decode batch, #running-req: 1, #token: 242, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.75, #queue-req: 0


    [2026-04-02 00:19:22] Decode batch, #running-req: 1, #token: 282, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.63, #queue-req: 0


    [2026-04-02 00:19:22] Decode batch, #running-req: 1, #token: 322, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.75, #queue-req: 0


    [2026-04-02 00:19:23] Decode batch, #running-req: 1, #token: 362, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.70, #queue-req: 0


    [2026-04-02 00:19:24] Decode batch, #running-req: 1, #token: 402, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.54, #queue-req: 0


    [2026-04-02 00:19:25] Decode batch, #running-req: 1, #token: 442, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.47, #queue-req: 0


    [2026-04-02 00:19:25] Decode batch, #running-req: 1, #token: 482, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.42, #queue-req: 0


    [2026-04-02 00:19:26] Decode batch, #running-req: 1, #token: 522, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.86, #queue-req: 0


    [2026-04-02 00:19:27] Decode batch, #running-req: 1, #token: 562, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.77, #queue-req: 0


    [2026-04-02 00:19:28] Decode batch, #running-req: 1, #token: 602, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.65, #queue-req: 0


    [2026-04-02 00:19:28] Decode batch, #running-req: 1, #token: 642, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.46, #queue-req: 0


    [2026-04-02 00:19:29] Decode batch, #running-req: 1, #token: 682, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.70, #queue-req: 0


    [2026-04-02 00:19:30] Decode batch, #running-req: 1, #token: 722, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.69, #queue-req: 0


    [2026-04-02 00:19:31] Decode batch, #running-req: 1, #token: 762, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.58, #queue-req: 0


    [2026-04-02 00:19:31] Decode batch, #running-req: 1, #token: 802, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.67, #queue-req: 0


    [2026-04-02 00:19:32] Decode batch, #running-req: 1, #token: 842, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.75, #queue-req: 0


    [2026-04-02 00:19:33] Decode batch, #running-req: 1, #token: 882, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.80, #queue-req: 0


    [2026-04-02 00:19:34] Decode batch, #running-req: 1, #token: 922, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.11, #queue-req: 0


    [2026-04-02 00:19:34] Decode batch, #running-req: 1, #token: 962, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.74, #queue-req: 0


    [2026-04-02 00:19:35] Decode batch, #running-req: 1, #token: 1002, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.65, #queue-req: 0


    [2026-04-02 00:19:36] INFO:     127.0.0.1:41954 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
