...
```
    ...
    2026-04-05 07:48:20,461 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-05 07:48:20] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 266.00it/s]
    ...
    2026-04-05 07:48:53,950 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-05 07:48:53] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    2026-04-05 07:49:27,952 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-05 07:49:27] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 296.79it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 209.44it/s]
    ...
    2026-04-05 07:50:04,627 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-05 07:50:04] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-05 07:50:33] Load weight end. elapsed=3.02 s, type=LlamaForCausalLM, avail mem=63.48 GB, mem usage=10.46 GB.
    [2026-04-05 07:50:33] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19262.02it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 12945.38it/s]
    [2026-04-05 07:50:33] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    [2026-04-05 07:50:33] No model.safetensors.index.json found in remote.
    ...
    [2026-04-05 07:50:33] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    [2026-04-05 07:50:33] No model.safetensors.index.json found in remote.
    ...
    [2026-04-05 07:50:34] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    [2026-04-05 07:50:34] No model.safetensors.index.json found in remote.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 114.55it/s]


    [2026-04-05 07:50:36] Using KV cache dtype: torch.bfloat16
    [2026-04-05 07:50:36] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-04-05 07:50:36] Memory pool end. avail mem=58.26 GB
    [2026-04-05 07:50:37] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-04-05 07:50:39] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=57.49 GB


    [2026-04-05 07:50:40] INFO:     Started server process [3133077]
    [2026-04-05 07:50:40] INFO:     Waiting for application startup.
    [2026-04-05 07:50:40] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-04-05 07:50:40] INFO:     Application startup complete.
    [2026-04-05 07:50:40] INFO:     Uvicorn running on http://127.0.0.1:33147 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-04-05 07:50:40] INFO:     127.0.0.1:58022 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-04-05 07:50:41] INFO:     127.0.0.1:58032 - "GET /model_info HTTP/1.1" 200 OK


    2026-04-05 07:50:41,684 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-05 07:50:41] Unexpected error during package walk: cutlass.cute.experimental


    [2026-04-05 07:50:42] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, cuda graph: False, input throughput (token/s): 0.00
    [2026-04-05 07:50:42] INFO:     127.0.0.1:58034 - "POST /generate HTTP/1.1" 200 OK
    [2026-04-05 07:50:42] The server is fired up and ready to roll!
...
```
    ...
    [2026-04-05 07:50:45] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 1, cuda graph: False, input throughput (token/s): 2.20
    [2026-04-05 07:50:45] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, cuda graph: False, input throughput (token/s): 472.29


    [2026-04-05 07:50:46] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.44, #queue-req: 1


    [2026-04-05 07:50:46] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, cuda graph: False, input throughput (token/s): 7.69
    [2026-04-05 07:50:46] Decode batch, #running-req: 2, #token: 95, token usage: 0.00, cuda graph: False, gen throughput (token/s): 109.02, #queue-req: 0


    [2026-04-05 07:50:47] Decode batch, #running-req: 2, #token: 175, token usage: 0.01, cuda graph: False, gen throughput (token/s): 123.05, #queue-req: 0


    [2026-04-05 07:50:48] Decode batch, #running-req: 1, #token: 162, token usage: 0.01, cuda graph: False, gen throughput (token/s): 92.84, #queue-req: 0


    [2026-04-05 07:50:48] Decode batch, #running-req: 1, #token: 202, token usage: 0.01, cuda graph: False, gen throughput (token/s): 52.40, #queue-req: 0


    [2026-04-05 07:50:49] Decode batch, #running-req: 1, #token: 242, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.21, #queue-req: 0


    [2026-04-05 07:50:50] Decode batch, #running-req: 1, #token: 282, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.08, #queue-req: 0


    [2026-04-05 07:50:51] Decode batch, #running-req: 1, #token: 322, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.85, #queue-req: 0


    [2026-04-05 07:50:52] Decode batch, #running-req: 1, #token: 362, token usage: 0.02, cuda graph: False, gen throughput (token/s): 47.95, #queue-req: 0


    [2026-04-05 07:50:52] Decode batch, #running-req: 1, #token: 402, token usage: 0.02, cuda graph: False, gen throughput (token/s): 50.05, #queue-req: 0


    [2026-04-05 07:50:53] Decode batch, #running-req: 1, #token: 442, token usage: 0.02, cuda graph: False, gen throughput (token/s): 59.97, #queue-req: 0


    [2026-04-05 07:50:54] Decode batch, #running-req: 1, #token: 482, token usage: 0.02, cuda graph: False, gen throughput (token/s): 59.95, #queue-req: 0


    [2026-04-05 07:50:55] Decode batch, #running-req: 1, #token: 522, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.17, #queue-req: 0


    [2026-04-05 07:50:55] Decode batch, #running-req: 1, #token: 562, token usage: 0.03, cuda graph: False, gen throughput (token/s): 50.89, #queue-req: 0


    [2026-04-05 07:50:56] Decode batch, #running-req: 1, #token: 602, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.02, #queue-req: 0


    [2026-04-05 07:50:57] Decode batch, #running-req: 1, #token: 642, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.59, #queue-req: 0


    [2026-04-05 07:50:58] Decode batch, #running-req: 1, #token: 682, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.24, #queue-req: 0


    [2026-04-05 07:50:59] Decode batch, #running-req: 1, #token: 722, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.65, #queue-req: 0


    [2026-04-05 07:50:59] Decode batch, #running-req: 1, #token: 762, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.60, #queue-req: 0


    [2026-04-05 07:51:00] Decode batch, #running-req: 1, #token: 802, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.42, #queue-req: 0


    [2026-04-05 07:51:01] Decode batch, #running-req: 1, #token: 842, token usage: 0.04, cuda graph: False, gen throughput (token/s): 59.14, #queue-req: 0


    [2026-04-05 07:51:01] Decode batch, #running-req: 1, #token: 882, token usage: 0.04, cuda graph: False, gen throughput (token/s): 63.45, #queue-req: 0


    [2026-04-05 07:51:02] Decode batch, #running-req: 1, #token: 922, token usage: 0.05, cuda graph: False, gen throughput (token/s): 63.84, #queue-req: 0


    [2026-04-05 07:51:03] Decode batch, #running-req: 1, #token: 962, token usage: 0.05, cuda graph: False, gen throughput (token/s): 63.69, #queue-req: 0


    [2026-04-05 07:51:03] Decode batch, #running-req: 1, #token: 1002, token usage: 0.05, cuda graph: False, gen throughput (token/s): 63.68, #queue-req: 0


    [2026-04-05 07:51:04] INFO:     127.0.0.1:37294 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
