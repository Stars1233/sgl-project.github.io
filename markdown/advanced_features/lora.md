...
```
    ...
    2026-04-03 06:10:45.420 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:10:45] Persistent cache disabled, using in-memory JIT cache
    2026-04-03 06:10:45.420 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:10:45] Persistent cache disabled, using in-memory JIT cache
    2026-04-03 06:10:45.420 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:10:45] Persistent cache disabled, using in-memory JIT cache
    ...
    2026-04-03 06:11:00,395 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-03 06:11:00] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    2026-04-03 06:11:25.703 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:11:25] Persistent cache disabled, using in-memory JIT cache
    2026-04-03 06:11:25.703 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:11:25] Persistent cache disabled, using in-memory JIT cache
    2026-04-03 06:11:25.703 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:11:25] Persistent cache disabled, using in-memory JIT cache
    ...
    2026-04-03 06:11:40,136 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-03 06:11:40] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    2026-04-03 06:12:04.627 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:12:04] Persistent cache disabled, using in-memory JIT cache
    2026-04-03 06:12:04.627 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:12:04] Persistent cache disabled, using in-memory JIT cache
    2026-04-03 06:12:04.627 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:12:04] Persistent cache disabled, using in-memory JIT cache
    ...
    2026-04-03 06:12:16,222 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-03 06:12:16] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 780.63it/s]
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 145.44it/s]
...
```
    ...
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    2026-04-03 06:12:43.865 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:12:43] Persistent cache disabled, using in-memory JIT cache
    2026-04-03 06:12:43.866 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:12:43] Persistent cache disabled, using in-memory JIT cache
    2026-04-03 06:12:43.866 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:12:43] Persistent cache disabled, using in-memory JIT cache
    2026-04-03 06:12:43.866 DEBUG Persistent cache disabled, using in-memory JIT cache
    ...
    2026-04-03 06:12:59,685 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-03 06:12:59] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 1225.96it/s]
...
```
    ...
    2026-04-03 06:13:25.917 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:13:25] Persistent cache disabled, using in-memory JIT cache
    2026-04-03 06:13:25.918 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-03 06:13:25] Persistent cache disabled, using in-memory JIT cache


    [2026-04-03 06:13:27] Load weight begin. avail mem=124.12 GB
    [2026-04-03 06:13:27] Found local HF snapshot for meta-llama/Meta-Llama-3.1-8B-Instruct at /root/.cache/huggingface/hub/models--meta-llama--Meta-Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659; skipping download.
    ...
    [2026-04-03 06:13:30] Load weight end. elapsed=3.32 s, type=LlamaForCausalLM, avail mem=107.82 GB, mem usage=16.30 GB.
    [2026-04-03 06:13:30] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 16561.91it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 17278.29it/s]
    [2026-04-03 06:13:31] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.


    [2026-04-03 06:13:31] No model.safetensors.index.json found in remote.
    ...
    [2026-04-03 06:13:31] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-04-03 06:13:32] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    [2026-04-03 06:13:32] No model.safetensors.index.json found in remote.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 101.33it/s]


    [2026-04-03 06:13:35] Using KV cache dtype: torch.bfloat16
    [2026-04-03 06:13:35] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-04-03 06:13:35] Memory pool end. avail mem=102.59 GB
    [2026-04-03 06:13:36] Warming up fused_temperature_softmax (multi-pass autotune, vocab_size=128256, logits_dtype=torch.bfloat16) ...


    [2026-04-03 06:13:39] Multi-pass autotune result: BLOCK_SIZE=32768, num_warps=32, num_stages=4
    [2026-04-03 06:13:39] fused_temperature_softmax warmup done (vocab_size=128256).
    [2026-04-03 06:13:39] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-04-03 06:13:42] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=101.01 GB


    [2026-04-03 06:13:42] INFO:     Started server process [1856533]
    [2026-04-03 06:13:42] INFO:     Waiting for application startup.
    [2026-04-03 06:13:42] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-04-03 06:13:42] INFO:     Application startup complete.
    [2026-04-03 06:13:42] INFO:     Uvicorn running on http://127.0.0.1:33646 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-04-03 06:13:43] INFO:     127.0.0.1:32970 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-04-03 06:13:43] INFO:     127.0.0.1:32974 - "GET /model_info HTTP/1.1" 200 OK


    2026-04-03 06:13:44,291 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-03 06:13:44] Unexpected error during package walk: cutlass.cute.experimental


    [2026-04-03 06:13:45] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, cuda graph: False, input throughput (token/s): 0.00
    [2026-04-03 06:13:45] INFO:     127.0.0.1:32984 - "POST /generate HTTP/1.1" 200 OK
    [2026-04-03 06:13:45] The server is fired up and ready to roll!
...
```
    ...
    [2026-04-03 06:13:48] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 1, cuda graph: False, input throughput (token/s): 1.83
    [2026-04-03 06:13:48] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, cuda graph: False, input throughput (token/s): 359.75


    [2026-04-03 06:13:49] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 2.64, #queue-req: 1


    [2026-04-03 06:13:50] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, cuda graph: False, input throughput (token/s): 5.94
    [2026-04-03 06:13:50] Decode batch, #running-req: 2, #token: 96, token usage: 0.00, cuda graph: False, gen throughput (token/s): 89.39, #queue-req: 0


    [2026-04-03 06:13:51] Decode batch, #running-req: 2, #token: 176, token usage: 0.01, cuda graph: False, gen throughput (token/s): 103.55, #queue-req: 0


    [2026-04-03 06:13:51] Decode batch, #running-req: 1, #token: 162, token usage: 0.01, cuda graph: False, gen throughput (token/s): 79.87, #queue-req: 0


    [2026-04-03 06:13:52] Decode batch, #running-req: 1, #token: 202, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.83, #queue-req: 0


    [2026-04-03 06:13:53] Decode batch, #running-req: 1, #token: 242, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.10, #queue-req: 0


    [2026-04-03 06:13:54] Decode batch, #running-req: 1, #token: 282, token usage: 0.01, cuda graph: False, gen throughput (token/s): 53.70, #queue-req: 0


    [2026-04-03 06:13:54] Decode batch, #running-req: 1, #token: 322, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.06, #queue-req: 0


    [2026-04-03 06:13:55] Decode batch, #running-req: 1, #token: 362, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.09, #queue-req: 0


    [2026-04-03 06:13:56] Decode batch, #running-req: 1, #token: 402, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.16, #queue-req: 0


    [2026-04-03 06:13:57] Decode batch, #running-req: 1, #token: 442, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.21, #queue-req: 0


    [2026-04-03 06:13:57] Decode batch, #running-req: 1, #token: 482, token usage: 0.02, cuda graph: False, gen throughput (token/s): 53.87, #queue-req: 0


    [2026-04-03 06:13:58] Decode batch, #running-req: 1, #token: 522, token usage: 0.03, cuda graph: False, gen throughput (token/s): 51.00, #queue-req: 0


    [2026-04-03 06:13:59] Decode batch, #running-req: 1, #token: 562, token usage: 0.03, cuda graph: False, gen throughput (token/s): 48.17, #queue-req: 0


    [2026-04-03 06:14:00] Decode batch, #running-req: 1, #token: 602, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.34, #queue-req: 0


    [2026-04-03 06:14:01] Decode batch, #running-req: 1, #token: 642, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.57, #queue-req: 0


    [2026-04-03 06:14:01] Decode batch, #running-req: 1, #token: 682, token usage: 0.03, cuda graph: False, gen throughput (token/s): 47.21, #queue-req: 0


    [2026-04-03 06:14:02] Decode batch, #running-req: 1, #token: 722, token usage: 0.04, cuda graph: False, gen throughput (token/s): 46.70, #queue-req: 0


    [2026-04-03 06:14:03] Decode batch, #running-req: 1, #token: 762, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.59, #queue-req: 0


    [2026-04-03 06:14:04] Decode batch, #running-req: 1, #token: 802, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.21, #queue-req: 0


    [2026-04-03 06:14:04] Decode batch, #running-req: 1, #token: 842, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.36, #queue-req: 0


    [2026-04-03 06:14:05] Decode batch, #running-req: 1, #token: 882, token usage: 0.04, cuda graph: False, gen throughput (token/s): 53.26, #queue-req: 0


    [2026-04-03 06:14:06] Decode batch, #running-req: 1, #token: 922, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.17, #queue-req: 0


    [2026-04-03 06:14:07] Decode batch, #running-req: 1, #token: 962, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.41, #queue-req: 0


    [2026-04-03 06:14:07] Decode batch, #running-req: 1, #token: 1002, token usage: 0.05, cuda graph: False, gen throughput (token/s): 53.35, #queue-req: 0


    [2026-04-03 06:14:08] INFO:     127.0.0.1:35584 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
