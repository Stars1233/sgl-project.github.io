...
```
    ...
    [2026-03-29 04:16:00] numactl command not found, skipping NUMA node configuration for GPU. Install numactl (e.g., apt-get install numactl) to enable automatic NUMA binding.


    [2026-03-29 04:16:08] numactl command not found, skipping NUMA node configuration for GPU. Install numactl (e.g., apt-get install numactl) to enable automatic NUMA binding.
    ...
    2026-03-29 04:16:12.949 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:16:12] Persistent cache disabled, using in-memory JIT cache
    2026-03-29 04:16:12.949 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:16:12] Persistent cache disabled, using in-memory JIT cache
    2026-03-29 04:16:12.949 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:16:12] Persistent cache disabled, using in-memory JIT cache
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 128.39it/s]
...
```
    ...
    /actions-runner/_work/sglang/sglang/python/sglang/srt/entrypoints/http_server.py:175: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      from sglang.srt.utils.json_response import (
    [2026-03-29 04:16:36] numactl command not found, skipping NUMA node configuration for GPU. Install numactl (e.g., apt-get install numactl) to enable automatic NUMA binding.


    [2026-03-29 04:16:43] numactl command not found, skipping NUMA node configuration for GPU. Install numactl (e.g., apt-get install numactl) to enable automatic NUMA binding.
    ...
    2026-03-29 04:16:52.859 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:16:52] Persistent cache disabled, using in-memory JIT cache
    2026-03-29 04:16:52.859 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:16:52] Persistent cache disabled, using in-memory JIT cache
    2026-03-29 04:16:52.859 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:16:52] Persistent cache disabled, using in-memory JIT cache
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 119.54it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 7996.77it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 9586.98it/s]
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 239.66it/s]
...
```
    ...
    /actions-runner/_work/sglang/sglang/python/sglang/srt/entrypoints/http_server.py:175: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      from sglang.srt.utils.json_response import (
    [2026-03-29 04:17:17] numactl command not found, skipping NUMA node configuration for GPU. Install numactl (e.g., apt-get install numactl) to enable automatic NUMA binding.


    [2026-03-29 04:17:24] numactl command not found, skipping NUMA node configuration for GPU. Install numactl (e.g., apt-get install numactl) to enable automatic NUMA binding.
    ...
    2026-03-29 04:17:28.834 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:17:28] Persistent cache disabled, using in-memory JIT cache
    2026-03-29 04:17:28.834 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:17:28] Persistent cache disabled, using in-memory JIT cache
    2026-03-29 04:17:28.834 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:17:28] Persistent cache disabled, using in-memory JIT cache
...
```
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 214.08it/s]
...
```
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 120.97it/s]
...
```
    ...
    /actions-runner/_work/sglang/sglang/python/sglang/srt/entrypoints/http_server.py:175: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      from sglang.srt.utils.json_response import (
    [2026-03-29 04:17:54] numactl command not found, skipping NUMA node configuration for GPU. Install numactl (e.g., apt-get install numactl) to enable automatic NUMA binding.


    [2026-03-29 04:18:01] numactl command not found, skipping NUMA node configuration for GPU. Install numactl (e.g., apt-get install numactl) to enable automatic NUMA binding.
    ...
    2026-03-29 04:18:06.024 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:18:06] Persistent cache disabled, using in-memory JIT cache
    2026-03-29 04:18:06.024 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:18:06] Persistent cache disabled, using in-memory JIT cache
    2026-03-29 04:18:06.024 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-29 04:18:06] Persistent cache disabled, using in-memory JIT cache
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 255.70it/s]
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 89.66it/s]
...
```
    ...
    [2026-03-29 04:18:47] Load weight begin. avail mem=121.65 GB


    [2026-03-29 04:18:47] Found local HF snapshot for meta-llama/Meta-Llama-3.1-8B-Instruct at /root/.cache/huggingface/hub/models--meta-llama--Meta-Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659; skipping download.
    ...
    [2026-03-29 04:18:50] Load weight end. elapsed=3.38 s, type=LlamaForCausalLM, avail mem=106.51 GB, mem usage=15.14 GB.
    [2026-03-29 04:18:50] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 9692.21it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10094.59it/s]
    [2026-03-29 04:18:50] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.


    [2026-03-29 04:18:50] No model.safetensors.index.json found in remote.
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 245.07it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 8124.56it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 8701.88it/s]
    [2026-03-29 04:18:51] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.


    [2026-03-29 04:18:51] No model.safetensors.index.json found in remote.
    ...
    [2026-03-29 04:18:52] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    [2026-03-29 04:18:52] No model.safetensors.index.json found in remote.
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 88.31it/s]


    [2026-03-29 04:18:56] Using KV cache dtype: torch.bfloat16
    [2026-03-29 04:18:56] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-03-29 04:18:56] Memory pool end. avail mem=101.25 GB
    [2026-03-29 04:18:56] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-03-29 04:18:59] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=101.13 GB


    [2026-03-29 04:19:00] INFO:     Started server process [2153698]
    [2026-03-29 04:19:00] INFO:     Waiting for application startup.
    [2026-03-29 04:19:00] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-03-29 04:19:00] INFO:     Application startup complete.
    [2026-03-29 04:19:00] INFO:     Uvicorn running on http://127.0.0.1:39061 (Press CTRL+C to quit)
    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-03-29 04:19:00] INFO:     127.0.0.1:48088 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-03-29 04:19:01] INFO:     127.0.0.1:48094 - "GET /model_info HTTP/1.1" 200 OK


    [2026-03-29 04:19:01] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, cuda graph: False, input throughput (token/s): 0.00
    [2026-03-29 04:19:02] INFO:     127.0.0.1:48102 - "POST /generate HTTP/1.1" 200 OK
    [2026-03-29 04:19:02] The server is fired up and ready to roll!
...
```
    ...
    [2026-03-29 04:19:05] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 1, cuda graph: False, input throughput (token/s): 1.92
    [2026-03-29 04:19:05] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, cuda graph: False, input throughput (token/s): 422.84


    [2026-03-29 04:19:06] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 2.84, #queue-req: 1


    [2026-03-29 04:19:06] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, cuda graph: False, input throughput (token/s): 6.76
    [2026-03-29 04:19:07] Decode batch, #running-req: 2, #token: 96, token usage: 0.00, cuda graph: False, gen throughput (token/s): 94.05, #queue-req: 0


    [2026-03-29 04:19:07] Decode batch, #running-req: 2, #token: 176, token usage: 0.01, cuda graph: False, gen throughput (token/s): 104.41, #queue-req: 0


    [2026-03-29 04:19:08] Decode batch, #running-req: 1, #token: 162, token usage: 0.01, cuda graph: False, gen throughput (token/s): 79.97, #queue-req: 0


    [2026-03-29 04:19:09] Decode batch, #running-req: 1, #token: 202, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.68, #queue-req: 0


    [2026-03-29 04:19:10] Decode batch, #running-req: 1, #token: 242, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.52, #queue-req: 0


    [2026-03-29 04:19:10] Decode batch, #running-req: 1, #token: 282, token usage: 0.01, cuda graph: False, gen throughput (token/s): 54.70, #queue-req: 0


    [2026-03-29 04:19:11] Decode batch, #running-req: 1, #token: 322, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.86, #queue-req: 0


    [2026-03-29 04:19:12] Decode batch, #running-req: 1, #token: 362, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.98, #queue-req: 0


    [2026-03-29 04:19:12] Decode batch, #running-req: 1, #token: 402, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.83, #queue-req: 0


    [2026-03-29 04:19:13] Decode batch, #running-req: 1, #token: 442, token usage: 0.02, cuda graph: False, gen throughput (token/s): 54.77, #queue-req: 0


    [2026-03-29 04:19:14] Decode batch, #running-req: 1, #token: 482, token usage: 0.02, cuda graph: False, gen throughput (token/s): 52.70, #queue-req: 0


    [2026-03-29 04:19:15] Decode batch, #running-req: 1, #token: 522, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.42, #queue-req: 0


    [2026-03-29 04:19:15] Decode batch, #running-req: 1, #token: 562, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.50, #queue-req: 0


    [2026-03-29 04:19:16] Decode batch, #running-req: 1, #token: 602, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.49, #queue-req: 0


    [2026-03-29 04:19:17] Decode batch, #running-req: 1, #token: 642, token usage: 0.03, cuda graph: False, gen throughput (token/s): 54.47, #queue-req: 0


    [2026-03-29 04:19:18] Decode batch, #running-req: 1, #token: 682, token usage: 0.03, cuda graph: False, gen throughput (token/s): 53.12, #queue-req: 0


    [2026-03-29 04:19:18] Decode batch, #running-req: 1, #token: 722, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.61, #queue-req: 0


    [2026-03-29 04:19:19] Decode batch, #running-req: 1, #token: 762, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.75, #queue-req: 0


    [2026-03-29 04:19:20] Decode batch, #running-req: 1, #token: 802, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.39, #queue-req: 0


    [2026-03-29 04:19:21] Decode batch, #running-req: 1, #token: 842, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.44, #queue-req: 0


    [2026-03-29 04:19:21] Decode batch, #running-req: 1, #token: 882, token usage: 0.04, cuda graph: False, gen throughput (token/s): 54.78, #queue-req: 0


    [2026-03-29 04:19:22] Decode batch, #running-req: 1, #token: 922, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.81, #queue-req: 0


    [2026-03-29 04:19:23] Decode batch, #running-req: 1, #token: 962, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.77, #queue-req: 0


    [2026-03-29 04:19:24] Decode batch, #running-req: 1, #token: 1002, token usage: 0.05, cuda graph: False, gen throughput (token/s): 54.54, #queue-req: 0


    [2026-03-29 04:19:24] INFO:     127.0.0.1:53106 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
