...
```
    ...
    2026-04-05 16:49:53,907 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-05 16:49:53] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    2026-04-05 16:50:30,214 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-05 16:50:30] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    2026-04-05 16:51:03,672 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-05 16:51:03] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 146.62it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 17697.49it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 76608.29it/s]
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 97.66it/s]
    ...
    2026-04-05 16:51:41,200 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-05 16:51:41] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-05 16:52:10] Load weight end. elapsed=3.22 s, type=LlamaForCausalLM, avail mem=124.11 GB, mem usage=15.02 GB.
    [2026-04-05 16:52:10] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 10727.12it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 17385.72it/s]
    [2026-04-05 16:52:10] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    [2026-04-05 16:52:10] No model.safetensors.index.json found in remote.
    ...
    [2026-04-05 16:52:10] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    ...
    [2026-04-05 16:52:11] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    [2026-04-05 16:52:11] No model.safetensors.index.json found in remote.
    Multi-thread loading shards:   0% Completed | 0/1 [00:00<?, ?it/s]Multi-thread loading shards: 100% Completed | 1/1 [00:00<00:00, 96.01it/s]


    [2026-04-05 16:52:14] Using KV cache dtype: torch.bfloat16
    [2026-04-05 16:52:14] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-04-05 16:52:14] Memory pool end. avail mem=118.88 GB
    [2026-04-05 16:52:14] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-04-05 16:52:17] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=118.78 GB


    [2026-04-05 16:52:17] INFO:     Started server process [411826]
    [2026-04-05 16:52:17] INFO:     Waiting for application startup.
    [2026-04-05 16:52:17] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-04-05 16:52:17] INFO:     Application startup complete.
    [2026-04-05 16:52:17] INFO:     Uvicorn running on http://127.0.0.1:33322 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-04-05 16:52:18] INFO:     127.0.0.1:45188 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-04-05 16:52:18] INFO:     127.0.0.1:49378 - "GET /model_info HTTP/1.1" 200 OK


    2026-04-05 16:52:19,388 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-05 16:52:19] Unexpected error during package walk: cutlass.cute.experimental


    [2026-04-05 16:52:20] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, cuda graph: False, input throughput (token/s): 0.00
    [2026-04-05 16:52:20] INFO:     127.0.0.1:49386 - "POST /generate HTTP/1.1" 200 OK
    [2026-04-05 16:52:20] The server is fired up and ready to roll!
...
```
    ...
    [2026-04-05 16:52:23] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 1, cuda graph: False, input throughput (token/s): 1.94
    [2026-04-05 16:52:23] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, cuda graph: False, input throughput (token/s): 437.49


    [2026-04-05 16:52:24] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 3.26, #queue-req: 1


    [2026-04-05 16:52:24] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, cuda graph: False, input throughput (token/s): 7.04
    [2026-04-05 16:52:25] Decode batch, #running-req: 2, #token: 96, token usage: 0.00, cuda graph: False, gen throughput (token/s): 100.38, #queue-req: 0


    [2026-04-05 16:52:25] Decode batch, #running-req: 2, #token: 176, token usage: 0.01, cuda graph: False, gen throughput (token/s): 109.84, #queue-req: 0


    [2026-04-05 16:52:26] Decode batch, #running-req: 1, #token: 162, token usage: 0.01, cuda graph: False, gen throughput (token/s): 83.24, #queue-req: 0


    [2026-04-05 16:52:27] Decode batch, #running-req: 1, #token: 202, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.93, #queue-req: 0


    [2026-04-05 16:52:27] Decode batch, #running-req: 1, #token: 242, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.88, #queue-req: 0


    [2026-04-05 16:52:28] Decode batch, #running-req: 1, #token: 282, token usage: 0.01, cuda graph: False, gen throughput (token/s): 56.36, #queue-req: 0


    [2026-04-05 16:52:29] Decode batch, #running-req: 1, #token: 322, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.80, #queue-req: 0


    [2026-04-05 16:52:30] Decode batch, #running-req: 1, #token: 362, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.87, #queue-req: 0


    [2026-04-05 16:52:30] Decode batch, #running-req: 1, #token: 402, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.61, #queue-req: 0


    [2026-04-05 16:52:31] Decode batch, #running-req: 1, #token: 442, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.84, #queue-req: 0


    [2026-04-05 16:52:32] Decode batch, #running-req: 1, #token: 482, token usage: 0.02, cuda graph: False, gen throughput (token/s): 56.94, #queue-req: 0


    [2026-04-05 16:52:32] Decode batch, #running-req: 1, #token: 522, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.25, #queue-req: 0


    [2026-04-05 16:52:33] Decode batch, #running-req: 1, #token: 562, token usage: 0.03, cuda graph: False, gen throughput (token/s): 55.98, #queue-req: 0


    [2026-04-05 16:52:34] Decode batch, #running-req: 1, #token: 602, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.07, #queue-req: 0


    [2026-04-05 16:52:34] Decode batch, #running-req: 1, #token: 642, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.01, #queue-req: 0


    [2026-04-05 16:52:35] Decode batch, #running-req: 1, #token: 682, token usage: 0.03, cuda graph: False, gen throughput (token/s): 56.07, #queue-req: 0


    [2026-04-05 16:52:36] Decode batch, #running-req: 1, #token: 722, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.09, #queue-req: 0


    [2026-04-05 16:52:37] Decode batch, #running-req: 1, #token: 762, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.02, #queue-req: 0


    [2026-04-05 16:52:37] Decode batch, #running-req: 1, #token: 802, token usage: 0.04, cuda graph: False, gen throughput (token/s): 55.93, #queue-req: 0


    [2026-04-05 16:52:38] Decode batch, #running-req: 1, #token: 842, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.15, #queue-req: 0


    [2026-04-05 16:52:39] Decode batch, #running-req: 1, #token: 882, token usage: 0.04, cuda graph: False, gen throughput (token/s): 56.20, #queue-req: 0


    [2026-04-05 16:52:39] Decode batch, #running-req: 1, #token: 922, token usage: 0.05, cuda graph: False, gen throughput (token/s): 56.17, #queue-req: 0


    [2026-04-05 16:52:40] Decode batch, #running-req: 1, #token: 962, token usage: 0.05, cuda graph: False, gen throughput (token/s): 56.06, #queue-req: 0


    [2026-04-05 16:52:41] Decode batch, #running-req: 1, #token: 1002, token usage: 0.05, cuda graph: False, gen throughput (token/s): 56.38, #queue-req: 0


    [2026-04-05 16:52:41] INFO:     127.0.0.1:49400 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
