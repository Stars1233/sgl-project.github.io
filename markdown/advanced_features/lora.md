...
```
    ...
    2026-04-01 21:24:31.855 DEBUG Persistent cache disabled, using in-memory JIT cache
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 144.96it/s]
    ...
    2026-04-01 21:24:42,561 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-01 21:24:42] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    2026-04-01 21:25:05.279 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 21:25:05] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 21:25:05.280 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 21:25:05] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 21:25:05.280 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 21:25:05] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 21:25:05.280 DEBUG Persistent cache disabled, using in-memory JIT cache
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 166.14it/s]
    ...
    2026-04-01 21:25:16,861 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-01 21:25:16] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    2026-04-01 21:25:39.279 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 21:25:39] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 21:25:39.280 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 21:25:39] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 21:25:39.280 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-04-01 21:25:39] Persistent cache disabled, using in-memory JIT cache
    2026-04-01 21:25:39.280 DEBUG Persistent cache disabled, using in-memory JIT cache
    ...
    2026-04-01 21:25:49,773 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-01 21:25:49] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 212.64it/s]
...
```
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 128.04it/s]
...
```
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 84.99it/s]
...
```
    ...
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    [Gloo] Rank 0 is connected to 0 peer ranks. Expected number of connected peer ranks is : 0
    2026-04-01 21:26:17.209 DEBUG Persistent cache disabled, using in-memory JIT cache
    ...
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 250.39it/s]
    ...
    2026-04-01 21:26:29,676 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-01 21:26:29] Unexpected error during package walk: cutlass.cute.experimental
...
```
    ...
    [2026-04-01 21:26:56] Load weight begin. avail mem=42.47 GB
    [2026-04-01 21:26:56] Found local HF snapshot for meta-llama/Meta-Llama-3.1-8B-Instruct at /root/.cache/huggingface/hub/models--meta-llama--Meta-Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659; skipping download.
    ...
    [2026-04-01 21:26:59] Load weight end. elapsed=3.18 s, type=LlamaForCausalLM, avail mem=45.15 GB, mem usage=-2.68 GB.
    [2026-04-01 21:26:59] Using csgmv as backend of LoRA kernels.
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 18766.46it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 19173.96it/s]
    [2026-04-01 21:26:59] Found local HF snapshot for Nutanix/Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json at /root/.cache/huggingface/hub/models--Nutanix--Meta-Llama-3.1-8B-Instruct_SFT_lora_4_alpha_16_humaneval_raw_json/snapshots/2c398740f3eba8dc63ee78999316b833a2833b6c; skipping download.
    [2026-04-01 21:26:59] No model.safetensors.index.json found in remote.
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 169.58it/s]


    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 15183.00it/s]
    Fetching 4 files:   0%|          | 0/4 [00:00<?, ?it/s]Fetching 4 files: 100%|██████████| 4/4 [00:00<00:00, 74565.40it/s]
    [2026-04-01 21:26:59] Found local HF snapshot for algoprog/fact-generation-llama-3.1-8b-instruct-lora at /root/.cache/huggingface/hub/models--algoprog--fact-generation-llama-3.1-8b-instruct-lora/snapshots/dc8cdfb21993a6cb46199d6b1d79f68a42b06439; skipping download.
    [2026-04-01 21:26:59] No model.safetensors.index.json found in remote.
    ...
    [2026-04-01 21:27:00] Found local HF snapshot for philschmid/code-llama-3-1-8b-text-to-sql-lora at /root/.cache/huggingface/hub/models--philschmid--code-llama-3-1-8b-text-to-sql-lora/snapshots/141fc3a09386a8baf0d7495c247ae2d1a565f69f; skipping download.
    [2026-04-01 21:27:00] No model.safetensors.index.json found in remote.
    Loading safetensors checkpoint shards:   0% Completed | 0/1 [00:00<?, ?it/s]Loading safetensors checkpoint shards: 100% Completed | 1/1 [00:00<00:00, 104.51it/s]


    [2026-04-01 21:27:04] Using KV cache dtype: torch.bfloat16
    [2026-04-01 21:27:04] KV Cache is allocated. #tokens: 20480, K size: 1.25 GB, V size: 1.25 GB
    [2026-04-01 21:27:04] Memory pool end. avail mem=39.90 GB
    [2026-04-01 21:27:04] Disable piecewise CUDA graph because --disable-piecewise-cuda-graph is set


    [2026-04-01 21:27:07] max_total_num_tokens=20480, chunked_prefill_size=8192, max_prefill_tokens=16384, max_running_requests=128, context_len=131072, available_gpu_mem=39.81 GB


    [2026-04-01 21:27:08] SubprocessWatchdog started, monitoring 2 process(es)
    [2026-04-01 21:27:08] INFO:     Started server process [497989]
    [2026-04-01 21:27:08] INFO:     Waiting for application startup.
    [2026-04-01 21:27:08] Using default chat sampling params from model generation config: {'temperature': 0.6, 'top_p': 0.9}
    [2026-04-01 21:27:08] INFO:     Application startup complete.
    [2026-04-01 21:27:08] INFO:     Uvicorn running on http://127.0.0.1:34598 (Press CTRL+C to quit)


    /usr/local/lib/python3.10/dist-packages/fastapi/routing.py:120: FastAPIDeprecationWarning: ORJSONResponse is deprecated, FastAPI now serializes data directly to JSON bytes via Pydantic when a return type or response model is set, which is faster and doesn't need a custom response class. Read more in the FastAPI docs: https://fastapi.tiangolo.com/advanced/custom-response/#orjson-or-response-model and https://fastapi.tiangolo.com/tutorial/response-model/
      response = await f(request)
    [2026-04-01 21:27:09] INFO:     127.0.0.1:48988 - "GET /v1/models HTTP/1.1" 200 OK


    [2026-04-01 21:27:09] INFO:     127.0.0.1:48998 - "GET /model_info HTTP/1.1" 200 OK


    2026-04-01 21:27:09,969 - CUTE_DSL - WARNING - [handle_import_error] - Unexpected error during package walk: cutlass.cute.experimental
    [2026-04-01 21:27:09] Unexpected error during package walk: cutlass.cute.experimental


    [2026-04-01 21:27:10] Prefill batch, #new-seq: 1, #new-token: 7, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 0, cuda graph: False, input throughput (token/s): 0.00
    [2026-04-01 21:27:10] INFO:     127.0.0.1:49004 - "POST /generate HTTP/1.1" 200 OK
    [2026-04-01 21:27:10] The server is fired up and ready to roll!
...
```
    ...
    [2026-04-01 21:27:14] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 0, #queue-req: 1, cuda graph: False, input throughput (token/s): 1.87
    [2026-04-01 21:27:14] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 1, cuda graph: False, input throughput (token/s): 479.18


    [2026-04-01 21:27:15] Decode batch, #running-req: 2, #token: 84, token usage: 0.00, cuda graph: False, gen throughput (token/s): 2.93, #queue-req: 1


    [2026-04-01 21:27:15] Prefill batch, #new-seq: 1, #new-token: 9, #cached-token: 0, token usage: 0.00, #running-req: 1, #queue-req: 0, cuda graph: False, input throughput (token/s): 5.69
    [2026-04-01 21:27:15] Decode batch, #running-req: 2, #token: 93, token usage: 0.00, cuda graph: False, gen throughput (token/s): 79.37, #queue-req: 0


    [2026-04-01 21:27:17] Decode batch, #running-req: 2, #token: 173, token usage: 0.01, cuda graph: False, gen throughput (token/s): 77.45, #queue-req: 0


    [2026-04-01 21:27:17] Decode batch, #running-req: 1, #token: 162, token usage: 0.01, cuda graph: False, gen throughput (token/s): 66.94, #queue-req: 0


    [2026-04-01 21:27:18] Decode batch, #running-req: 1, #token: 202, token usage: 0.01, cuda graph: False, gen throughput (token/s): 47.91, #queue-req: 0


    [2026-04-01 21:27:19] Decode batch, #running-req: 1, #token: 242, token usage: 0.01, cuda graph: False, gen throughput (token/s): 45.04, #queue-req: 0


    [2026-04-01 21:27:20] Decode batch, #running-req: 1, #token: 282, token usage: 0.01, cuda graph: False, gen throughput (token/s): 31.22, #queue-req: 0


    [2026-04-01 21:27:22] Decode batch, #running-req: 1, #token: 322, token usage: 0.02, cuda graph: False, gen throughput (token/s): 31.33, #queue-req: 0


    [2026-04-01 21:27:23] Decode batch, #running-req: 1, #token: 362, token usage: 0.02, cuda graph: False, gen throughput (token/s): 31.61, #queue-req: 0


    [2026-04-01 21:27:24] Decode batch, #running-req: 1, #token: 402, token usage: 0.02, cuda graph: False, gen throughput (token/s): 31.58, #queue-req: 0


    [2026-04-01 21:27:26] Decode batch, #running-req: 1, #token: 442, token usage: 0.02, cuda graph: False, gen throughput (token/s): 32.05, #queue-req: 0


    [2026-04-01 21:27:27] Decode batch, #running-req: 1, #token: 482, token usage: 0.02, cuda graph: False, gen throughput (token/s): 33.73, #queue-req: 0


    [2026-04-01 21:27:28] Decode batch, #running-req: 1, #token: 522, token usage: 0.03, cuda graph: False, gen throughput (token/s): 37.29, #queue-req: 0


    [2026-04-01 21:27:29] Decode batch, #running-req: 1, #token: 562, token usage: 0.03, cuda graph: False, gen throughput (token/s): 39.87, #queue-req: 0


    [2026-04-01 21:27:30] Decode batch, #running-req: 1, #token: 602, token usage: 0.03, cuda graph: False, gen throughput (token/s): 36.86, #queue-req: 0


    [2026-04-01 21:27:31] Decode batch, #running-req: 1, #token: 642, token usage: 0.03, cuda graph: False, gen throughput (token/s): 33.08, #queue-req: 0


    [2026-04-01 21:27:32] Decode batch, #running-req: 1, #token: 682, token usage: 0.03, cuda graph: False, gen throughput (token/s): 31.97, #queue-req: 0


    [2026-04-01 21:27:34] Decode batch, #running-req: 1, #token: 722, token usage: 0.04, cuda graph: False, gen throughput (token/s): 32.58, #queue-req: 0


    [2026-04-01 21:27:35] Decode batch, #running-req: 1, #token: 762, token usage: 0.04, cuda graph: False, gen throughput (token/s): 33.78, #queue-req: 0


    [2026-04-01 21:27:36] Decode batch, #running-req: 1, #token: 802, token usage: 0.04, cuda graph: False, gen throughput (token/s): 34.24, #queue-req: 0


    [2026-04-01 21:27:37] Decode batch, #running-req: 1, #token: 842, token usage: 0.04, cuda graph: False, gen throughput (token/s): 36.68, #queue-req: 0


    [2026-04-01 21:27:38] Decode batch, #running-req: 1, #token: 882, token usage: 0.04, cuda graph: False, gen throughput (token/s): 37.09, #queue-req: 0


    [2026-04-01 21:27:39] Decode batch, #running-req: 1, #token: 922, token usage: 0.05, cuda graph: False, gen throughput (token/s): 39.27, #queue-req: 0


    [2026-04-01 21:27:40] Decode batch, #running-req: 1, #token: 962, token usage: 0.05, cuda graph: False, gen throughput (token/s): 41.59, #queue-req: 0


    [2026-04-01 21:27:41] Decode batch, #running-req: 1, #token: 1002, token usage: 0.05, cuda graph: False, gen throughput (token/s): 41.65, #queue-req: 0


    [2026-04-01 21:27:42] INFO:     127.0.0.1:49006 - "POST /generate HTTP/1.1" 200 OK
    Output from lora0: 
