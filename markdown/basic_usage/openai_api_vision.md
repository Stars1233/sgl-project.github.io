...
```
    ...
    [2026-03-28 18:49:12] numactl command not found, skipping NUMA node configuration for GPU. Install numactl (e.g., apt-get install numactl) to enable automatic NUMA binding.


    2026-03-28 18:49:12.470 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-28 18:49:12] Persistent cache disabled, using in-memory JIT cache
    2026-03-28 18:49:12.470 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-28 18:49:12] Persistent cache disabled, using in-memory JIT cache
    2026-03-28 18:49:12.470 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-28 18:49:12] Persistent cache disabled, using in-memory JIT cache
    ...
    [2026-03-28 18:49:18] numactl command not found, skipping NUMA node configuration for GPU. Install numactl (e.g., apt-get install numactl) to enable automatic NUMA binding.


    2026-03-28 18:49:21.240 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-28 18:49:21] Persistent cache disabled, using in-memory JIT cache
    2026-03-28 18:49:21.240 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-28 18:49:21] Persistent cache disabled, using in-memory JIT cache
    2026-03-28 18:49:21.240 DEBUG Persistent cache disabled, using in-memory JIT cache
    [2026-03-28 18:49:21] Persistent cache disabled, using in-memory JIT cache
